...
- [x] **Rasterio Basics:** Handling `.tif` satellite data & Coordinate Reference Systems (CRS).
- [x] **Semantic Segmentation:** Applying U-Net to detect land/water bodies from space.
